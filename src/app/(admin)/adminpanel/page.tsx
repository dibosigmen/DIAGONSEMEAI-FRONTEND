  ...
  useEffect(() => {
    const fetchUserData = async () => {
      ...
      if (error) console.error(error);
        ...
        setUsers(data || []);
        // Store the username of the first user in localStorage
  ...
  return (
    <div className="p-6">
      ...
      <Link href="/admin-package">
        <button className="rounded-3xl border border-gray-200 dark:border-gray-700 bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl shadow-xl overflow-hidden px-4 py-2 mb-4 hover:bg-blue-500 hover:text-white transition">
          Set Packages
        </button>
      </Link>
      {/* CARD */}
                      ...
                      <div className="flex gap-2">
                        ...
                        <button
                          ...
                          onClick={() => {
                            ...
                            window.location.href = "/user-wise-packageid";
                          }}
                        >
                          📦
                        </button>
                        <Link href="/users-doings">
                          <button
                            className="p-2 rounded-lg bg-gray-200 hover:bg-blue-500 hover:text-white transition"
                            title="View"
                          >
